	...
	<div class="re-beehiiv-wrapper">
		<div class="re-beehiiv-tabs">
			<nav class="nav-tab-wrapper">
				<a class="nav-tab nav-tab-active" data-tab="re-beehiiv-import" id="re-beehiiv-import-tab" href="<?php echo esc_url( admin_url( 'admin.php?page=re-beehiiv-import' ) ); ?>">Manual Import</a>
				<a class="nav-tab" data-tab="re-beehiiv-auto-import" id="re-beehiiv-auto-import-tab" href="<?php echo esc_url( admin_url( 'admin.php?page=re-beehiiv-import&tab=auto-import' ) ); ?>">Auto Import</a>
			</nav>
		</div>
		<!-- Select: Content Type -->
		<fieldset>
