...
const ManualImport = () => {
	...
	const [groupName, setGroupName, removeGroupName] = useLocalStorage('groupName', null);
	const [totalQueuedCampaigns, setTotalQueuedCampaigns, removeTotalQueuedCampaigns] = useLocalStorage('totalQueuedCampaigns', null);
